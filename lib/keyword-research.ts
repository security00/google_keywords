...
export const filterCandidatesWithModel = async (
  ...
  const baseSystemPrompt = [
    "You are a keyword filtering assistant. Decide whether a keyword should be blocked based on SERP evidence.",
    ...
    "If SERP strongly suggests a title, person, brand, or news event, block it directly. When uncertain, lean toward blocking.",
  ].join("\n");
