...
export function ResetPasswordForm({ siteKey }: ResetPasswordFormProps) {
  return (
    <Suspense>
      <ResetPasswordFormContent siteKey={siteKey} />
    </Suspense>
  );
}

function ResetPasswordFormContent({ siteKey }: ResetPasswordFormProps) {
        ...
        <CardContent>
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <TurnstileField siteKey={siteKey} onToken={setTurnstileToken} resetSignal={turnstileReset} />
              {error && (
              ...
              <Button 
                type="submit" 
                className="w-full" 
                disabled={loading || !token || (Boolean(siteKey) && !turnstileToken)}
              >
